...
平台管理员须具备“数据看板-房源分析”菜单权限并可查看全量；运营人员须具备该菜单权限且仅查看授权城市；销售主管须具备该菜单权限且仅查看所属团队经纪人负责、并位于授权城市的楼盘和房源；经纪人、客服无本页菜单。聚合导出另需“房源分析导出”操作权限，查看 `LI-12`、`LI-13` 另需“前台事件分析”操作权限。城市、楼盘、商户、经纪人和标签均先按上述数据范围过滤；前台事件只可按聚合维度显示，禁止展示访问者手机号、设备标识、IP 或可识别轨迹。无前台事件分析权限时，曝光和咨询归因区不渲染。
